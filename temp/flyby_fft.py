...
store_data('para', data=[f'para_{window}_{shift}', 'juno_cyc_freq', f'para_{window}_{shift}'])
store_data('perp', data=[f'perp_{window}_{shift}', 'juno_cyc_freq', f'perp_{window}_{shift}'])
store_data('norm', data=[f'norm_{window}_{shift}', 'juno_cyc_freq', f'norm_{window}_{shift}'])
store_data('ratio', data=[f'ratio_{window}_{shift}', 'juno_cyc_freq', f'ratio_{window}_{shift}'])
